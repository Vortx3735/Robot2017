 ...
 *
 */
public class AutonTimedDriveTimedStepsToLeft extends CommandGroup {

    public AutonTimedDriveTimedStepsToLeft(){
    	/* All the Timing Needs Adjustment     |    */ 
    	/*                                    This */
    	/*                                     |   */
    	
    	addSequential(new ExpDrive(0.65, 0.0),1.25); /* Straight */
    	addSequential(new ExpDrive(0.65,-0.7),1.0); /* Turn Left */
