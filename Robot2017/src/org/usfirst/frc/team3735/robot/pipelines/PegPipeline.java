...
public class PegPipeline implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double[] hsvThresholdHue = {35.593220338983045, 80.53475935828877};
		double[] hsvThresholdSaturation = {0.0, 59.54545454545453};
		...
		double blurRadius = 3.7735849056603774;
	...
	public Rect getCentralRect(ArrayList<MatOfPoint> arr){
		for(MatOfPoint m : arr){
			...
			for(MatOfPoint n: arr){
				...
				if(VortxMath.isWithinThreshold(r.y, r2.y, 10) || 
				   VortxMath.isWithinThreshold(r.area(), r2.area(), 150)){
